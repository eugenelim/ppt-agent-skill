...
- [ ] A recorded **classification** of all 29 existing `<id>.html` as
...
- [ ] `smoke_test.py` phase 1 validates compat + typography for **both** tiers
...
- [ ] The gallery index renders a per-card **Cover | Detail** segmented toggle
...
- [ ] Category sections show enriched headers: cn/en label, a one-line
...
- [ ] `README.md` and `references/style-system.md` describe the two-tier model.
