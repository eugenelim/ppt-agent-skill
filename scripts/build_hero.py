#!/usr/bin/env python3
"""build_hero.py -- 把 29 张风格截图拼成 5 板块 hero 拼图

输出：
  assets/hero-all.png         总览：29 风格 5 板块网格（适合 README 顶部）
...
def build_all_categories_grid() -> Image.Image:
    ...
    draw.text((padding, padding + 50), "29 风格预览画廊", fill=(255, 255, 255), font=title_font)
